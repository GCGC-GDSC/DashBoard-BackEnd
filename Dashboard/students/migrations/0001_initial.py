    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_backlogs_opted_for_other_career_options', models.IntegerField(default=0)),
                ...
                ('under_campus', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='organization.campus')),
                ('under_institute', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='organization.institute')),
            ],
        ),
    ]
