...
class InstituteGradListSeralizer(serializers.ModelSerializer):
    ...
    def _student_details(self, obj):
        return {"total_students": obj.total_students, "total_final_years": obj.total_final_years,
                "total_backlogs": obj.total_backlogs,
                "total_higher_study_and_pay_crt": obj.total_higher_study_and_pay_crt}

    def _placement_details(self, obj):
        return {"total_students_eligible": obj.total_students_eligible,
                "total_not_intrested_in_placments": obj.total_not_intrested_in_placments,
                "total_offers": obj.total_offers, "placed": obj.total_placed, "yet_to_place": obj.total_yet_to_place,
                "total_multiple_offers": obj.total_multiple_offers}

    def _salary(self, obj):
        return {"highest": obj.highest_salary, "average": obj.average_salary, "lowest": obj.lowest_salary}
